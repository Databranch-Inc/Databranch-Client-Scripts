...
GET-ADCOMPUTER -filter {OperatingSystem -NotLike "*server*"} -properties * |select-object name,OperatingSystem,lastlogondate,enabled,ipv4address,description,primarygroup| Export-csv C:\Databranch\desktopsAD.csv -notypeinformation -encoding utf8

#Get AD information for users
GET-ADUSER -filter * -properties * |select-object name,lastlogondate,enabled,description,primarygroup | Export-csv C:\Databranch\usersAD.csv -notypeinformation -encoding utf8

#Get AD information for servers
GET-ADCOMPUTER -filter {OperatingSystem -Like "Windows* *server*"} -properties * |select-object name,OperatingSystem,lastlogondate,enabled,ipv4address,description,primarygroup| Export-csv C:\Databranch\serverAD.csv -notypeinformation -encoding utf8
