...
for /f "delims=" %%i in ('powershell -command "$auth = [Convert]::ToBase64String([Text.Encoding]::ASCII.GetBytes('!MYUSER!:!MYPASS!')); Write-Host $auth"') do set AUTH=%%i
