namespace ArnotOnboarding.Views
{
    partial class RequestorView
    {
        ...
        private System.Windows.Forms.Label  _lblExtension;
        ...
        private System.Windows.Forms.TextBox _txtExtension;
        ...
        private void InitializeComponent()
        {
            ...
            _lblExtension = new System.Windows.Forms.Label();
            ...
            _txtExtension = new System.Windows.Forms.TextBox();
            ...
            // ── Fields ──────────────────────────────────────────
            int lx = 48, fx = 200, fw = 300, fwShort = 140, fh = 28, rowH = 52, startY = 130;
            ...
            // Phone + Extension on same row
            SetupLabel(_lblPhone,      "Phone",       lx, startY + rowH * 3);
            SetupField(_txtPhone,      fx, startY + rowH * 3, fwShort, fh);

            _lblExtension.Text      = "Ext";
            _lblExtension.Font      = Theme.AppFonts.LabelBold;
            _lblExtension.ForeColor = Theme.AppColors.TextSecondary;
            _lblExtension.AutoSize  = false;
            _lblExtension.Size      = new System.Drawing.Size(28, fh);
            _lblExtension.Location  = new System.Drawing.Point(fx + fwShort + 20, startY + rowH * 3);
            _lblExtension.TextAlign = System.Drawing.ContentAlignment.MiddleLeft;
            _txtExtension.Location  = new System.Drawing.Point(fx + fwShort + 52, startY + rowH * 3);
            _txtExtension.Size      = new System.Drawing.Size(72, fh);
            _txtExtension.BackColor = Theme.AppColors.SurfaceVoid;
            _txtExtension.ForeColor = Theme.AppColors.TextPrimary;
            _txtExtension.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
            _txtExtension.Font      = Theme.AppFonts.Body;
            ...
            _formPanel.Controls.AddRange(new System.Windows.Forms.Control[]
            {
                ...
                _lblDepartment, _txtDepartment,
                _lblPhone, _txtPhone, _lblExtension, _txtExtension,
