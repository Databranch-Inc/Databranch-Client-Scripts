...
namespace ArnotOnboarding.Views.WizardPages
{
    public abstract class WizardPageBase : UserControl, IWizardPage
    {
        ...
        public virtual  string Validate() { return null; } // Most pages have no required fields
        ...
        protected const int ROW_HEIGHT       = 42;
        protected const int ROW_HEIGHT_TALL  = 54;   // For multi-line / taller fields
        protected const int START_Y          = 16;
        protected const int SECTION_GAP      = 20;   // Extra vertical space before a section header
        ...
        protected WizardPageBase()
        {
            ...
            this.Padding     = new Padding(0, 8, 0, 24);
        }
        ...
        /// <summary>Creates a right-aligned label for the left column.</summary>
        protected Label MakeLabel(string text, int y, bool bold = false)
        {
            return new Label
            {
                ...
                Location  = new Point(COL_LABEL_X, y + 4),
                Size      = new Size(COL_LABEL_W, 24),
        ...
        protected CheckBox MakeCheckBox(string text, int y, int xOffset = 0)
        {
            var cb = new CheckBox
            {
                Text      = text,
        ...
        protected DateTimePicker MakeDatePicker(int y)
        {
            var dtp = new DateTimePicker
            {
                ...
                ShowCheckBox          = true,  // Allows clearing the date
                Checked               = false,
                BackColor             = AppColors.SurfaceVoid,
                ForeColor             = AppColors.TextPrimary,
        ...
        /// <summary>Creates a DateTimePicker for time-only selection.</summary>
