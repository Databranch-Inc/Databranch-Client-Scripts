<#
New Databranch inventory report
This scrupt will gather the currnely found AD Servers, Desktops, and users for an enviornment.
Josh Britton
1/4/19
1.3.2
...
#Test for C:\Databranch on the Server
...
#Get AD information from desktops and laptops:
...
#Get AD information from desktops and servers:
...
#Updated 6/28/18 - Added additional filter to the server pull to include the wildcard for the registerd symbol (®) in Windows® Small Business Server 2011 Standard - Josh Britton
