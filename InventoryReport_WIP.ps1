...
1.4.1
=========================================================================================================
1.4.1 Update - Adding steps to combine Server and Desktop CSV files.
...
GET-ADCOMPUTER -filter {OperatingSystem -NotLike "*server*"} -properties * |select-object name,OperatingSystem,lastlogondate,enabled,ipv4address,primarygroup| Export-csv C:\Databranch\desktopsAD.csv -notypeinformation -encoding utf8

#Get AD information for users
GET-ADUSER -filter * -properties * |select-object name,lastlogondate,enabled,primarygroup | Export-csv C:\Databranch\usersAD.csv -notypeinformation -encoding utf8

#Get AD information for servers
GET-ADCOMPUTER -filter {OperatingSystem -Like "Windows* *server*"} -properties * |select-object name,OperatingSystem,lastlogondate,enabled,ipv4address,primarygroup| Export-csv C:\Databranch\serverAD.csv -notypeinformation -encoding utf8
...
Import-Csv C:\Databranch\desktopsFINAL.csv | Select-Object name,OperatingSystem,lastlogondate,enabled,ipv4address,primarygroup,UserName,Manufacturer,Model,SystemType,SerialNumber | Export-Csv C:\Databranch\desktopsFINAL.csv -notypeinformation -encoding utf8
