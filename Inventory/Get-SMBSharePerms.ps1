...
## ServerName for running locally
$server = hostname
...
$Shares = Get-WmiObject -ComputerName $Server -Class win32_share -Filter "Description != 'Remote Admin' and Description != 'Default share' and Description != 'Remote IPC' and Description != 'Printer Drivers' and Type = 0" | Select-Object Name -ExpandProperty Name
...
Export-Csv -Path c:\databranch\Share_PermissionExport.csv -NoTypeInformation -Encoding UTF8