...
===================================================================================================
    Modified for Databranch use - 12/14/21 - JB
...
$env:usrScanScope = 2
##E-mail Variable
$User = "smtp@databranch.com"
$PWord = ConvertTo-SecureString -String "Zob24400" -AsPlainText -Force
$SendTo = "jbritton@databranch.com"
$SMTPServer = "smtp.office365.com"
##Logging Location Variable
$LogTo = "C:\Databranch\log4j"
################################
